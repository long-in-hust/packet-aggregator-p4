...
class P4Switch(Switch):
    ...
    def __init__(self, name, sw_path = None, json_path = None,
        ...
        logfile = "/home/p4/other-p4/packet-aggregator-p4/tcptest/l2_agg_new/logs/devices/p4s.{}.log".format(self.name)
    ...
    def start(self, controllers):
        ...
        if self.pcap_dump:
            ...
            args.append("--pcap=/home/p4/other-p4/packet-aggregator-p4/tcptest/l2_agg_new/pcap")
